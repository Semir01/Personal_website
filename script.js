document.addEventListener("DOMContentLoaded", () => {
  ...
  fetch("menu.html") // Assuming menu.html is in the same directory as the current page
    ...
    .then((data) => {
      // Insert the menu HTML into the page
...
const closeProjectsModalButton = document.getElementById(
...
document.addEventListener("click", (event) => {
  ...
  const project = projects[category].find((project) => project.id === id);

  openProjectDetails(project);
});

const detailsModal = document.getElementById("project-details-modal");
const closeProjectDetailsButton = document.getElementById(
...
function openProjectDetails(project) {
  ...
  document.getElementById("details-main-image").src = project.image;
